    const PROJECTS = [
      ...
      },
      {
        ...
        detailTitle: `Eirkoo Recruitment`,
        detailSubtitle: `Internship, Dublin Ireland`,
        highlights: [
          `Processed and formatted 100+ résumés daily, supporting efficient candidate screening and placement across active searches`,
          `Conducted outreach to 30+ prospective clients and supported candidate placement, interview coordination, and day-to-day recruitment operations`,
          `Supported the team in managing and formatting back-end platforms to keep them up to date with the current client base`
        ],
        skills: ['Cross-cultural communication', 'Recruiting Operations', 'Applicant Tracking Systems: JobAdder']
      },
      {
        ...
        color: '#dd0033',
        theme: 'cfa',
        cardLink: 'images/Documents/Chic-Fil-A%20Final%20Project%20(1).pdf',
        tagline: ``,
      ...
      },
      {
        ...
        color: '#2b2622',
        theme: 'cava',
        cardLink: 'images/Documents/FINAL%20PAPER%20MANAGEMENT.pdf',
